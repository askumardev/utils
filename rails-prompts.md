...
| Prompt | Description |
|------|-------------|
| Generate Rails service object | Creates service class |
| Create REST API controller | Generates CRUD endpoints |
| Create background job | Generates ActiveJob |
| Add pagination | Adds pagination logic |
